        ...
        <>
            ...
            <div className="game-over-modal fixed">
                <div className="game-over-modal-container space-between flex align-center col h100 ">
                    <h1>GAME OVER</h1>
                    <div className="game-actions-container flex col w100">
                        ...
                        <div className="btn-container">
                            <img className="cursor" style={{ opacity: gauntlet.g2 ? '1' : '0' }} src={cursor} alt="" />
                            <button onMouseEnter={() => { setGauntlet(prevState => { return { ...prevState, g2: true } }) }}
                                onMouseLeave={() => { setGauntlet(prevState => { return { ...prevState, g2: false } }) }}>
                                <span>C</span>haracter Select</button>
                        </div>
                        <div className="btn-container">
                            <img className="cursor" style={{ opacity: gauntlet.g3 ? '1' : '0' }} src={cursor} alt="" />
                            <button onMouseEnter={() => { setGauntlet(prevState => { return { ...prevState, g3: true } }) }}
